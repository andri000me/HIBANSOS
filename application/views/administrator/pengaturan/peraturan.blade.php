<div class="">
    <div class="mt-3">
        ...
        <table class="table">
            @foreach($konten as $peraturan)
                <tr style="vertical-align: middle">
                    <th style="vertical-align: middle">{{$peraturan['judul']}}</th>
                    <th class="text-center">
                        <div class="d-flex">
                            <div>
                                <form class="form-inline" action="{{base_url('hapusPeraturan')}}" method="post">
                                    <button class="btn btn-danger  btn-sm">
                                        <i class="fas fa-minus"></i>
                                        Hapus
                                    </button>
                                    <input type="hidden" name="id" value="{{$peraturan['id']}}">
                                    <a target="_blank" role="button" href="{{base_url('lihatPeraturan/'.$peraturan['id'])}}" class="btn bg-main2 btn-sm">
    ...
    <div class="modal-dialog modal-side  modal-bottom-right" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body mx-3">
                <form action="{{base_url('tambahPeraturan')}}" method="post" enctype="multipart/form-data">

                            ...
                            @foreach($common_field['textarea'] as $field)
                                ...
                                <div class="col-6">
                                    <div class="md-form shadow-textarea position-relative mt-5">
                                        ...
                                        <textarea
                                                name="{{$field['name']}}"
                                                class="form-control md-textarea @if (!isset($formerror[$field['name']])&&!$preval[$field['name']]) initial @elseif (isset($preval[$field['name']]) && !isset($formerror[$field['name']])) is-valid @else is-invalid @endif"
                            ...
                            <div class="col-6">
                                <div class="md-form">
                                    ...
                                    <input id="datepicker"
                                           ...
                                           @endif
                                           class="form-control @if (!isset($formerror['tglKegiatan'])&&!$preval['tglKegiatan']) initial @elseif (isset($preval['tglKegiatan']) && !isset($formerror['tglKegiatan'])) is-valid @else is-invalid @endif"

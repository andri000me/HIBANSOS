                                ...
                                <div class="col-6">
                                    <div class="md-form shadow-textarea position-relative mt-5">
                                        ...
                                        <textarea
                                                ...
                                                class="form-control md-textarea <?php if(!isset($formerror[$field['name']])&&!$preval[$field['name']]): ?> initial <?php elseif($preval[$field['name']] && !isset($formerror[$field['name']])): ?> is-valid <?php else: ?> is-invalid <?php endif; ?>"
                            ...
                            <div class="col-6">
                                <div class="md-form">
                                    ...
                                    <input id="datepicker"
                                           ...
                                           <?php endif; ?>
                                           class="form-control <?php if(!isset($formerror['tglKegiatan'])&&!$preval['tglKegiatan']): ?> initial <?php elseif($preval['tglKegiatan'] && !isset($formerror['tglKegiatan'])): ?> is-valid <?php else: ?> is-invalid <?php endif; ?>"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ProgramFinal\application\views/user/editHibahBansos.blade.php ENDPATH**/ ?>
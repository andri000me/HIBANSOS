                ...
                <div class="col-12">
                    <?php $__env->startComponent('.operator.form.inforproposal',$proposal); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div>
                            <p class="p-1">
                            <?php if( rupiah($proposal['danaEvaluasiTAPD']) == rupiah($proposal['danaRekomendasiSKPD'])): ?>
                            Tidak memberikan rekomendasi
                            <?php else: ?>
                            <?php echo e(rupiah($proposal['danaEvaluasiTAPD'])); ?>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ProgramFinal\application\views/operator/detailPemeriksaan.blade.php ENDPATH**/ ?>
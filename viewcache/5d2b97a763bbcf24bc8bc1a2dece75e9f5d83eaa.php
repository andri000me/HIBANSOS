<div class="row mt-5">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo e(base_url('uploadlpj/'.$idHibahBansos)); ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-6">
                            <div class="md-form">
...
<?php $__env->stopSection(); ?><?php /**PATH C:\xampp\htdocs\ProgramFinal\application\views/user/upload_lpj.blade.php ENDPATH**/ ?>
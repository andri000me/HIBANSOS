<table class="table">
    ...
    <tr>
        ...
        <?php elseif($monitoring == 0 && $progres == 0): ?>
            <td class="text-center">-</td>
            <td class="text-center">-</td>
        <?php endif; ?>
    </tr>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\ProgramFinal\application\views/operator/pemeriksaan/pascaproposal.blade.php ENDPATH**/ ?>